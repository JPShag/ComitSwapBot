...
class SwapOrchestrator:
    ...
    async def start(self):
        ...
        self.background_tasks = [
            ...
            asyncio.create_task(self._monitor_swap_lifecycle(), name="lifecycle-monitor"),
        ]
        ...
        try:
            ...
            logger.error("💥 Background task crashed", error=str(e), task_count=len(self.background_tasks))
            raise
    ...
    async def _enrich_with_price_data(self, incomplete_swap: AtomicSwap):
        ...
        try:
            ...
            if current_rate:
                ...
                incomplete_swap.amount_xmr = await self.price_service.convert_btc_to_xmr(
